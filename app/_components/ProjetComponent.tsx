...
const projects = [
  {num: 1,
   ...
   {num: 2,
    ...
    stack:  [
      { name: "NestJS"}, { name: "MongoDb Atlas"},{ name: "React"},{ name: "Docker"}
    ],
   ...
   {num: 3,
    ...
    stack:  [
      { name: "Woocommerce"},{ name: "Elementor"}
    ],
   ...
   {num: 4,
    ...
    stack:  [
      { name: "Symfony"},,{ name: "Apiplatform"},{ name: "Angular"}
    ],
