      ...
      <div className="flex flex-col xl:flex-row gap-[30px]">
        ...
        <div className="flex-1">
          <form className="flex flex-col gap-6 p-10 bg-secondary rounded-xl">
            ...
            <Textarea className="h-[200px]" placeholder="Laissez votre message." />
            <Button size="lg" className="max-w-40">Envoyez un message</Button>
          </form>
        </div>
          ...
          <ul className="flex flex-col gap-10">
            ...
            <li className="flex items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <h3 className="text-white/60 text-xl font-nunito-sans">nahima.toumi697@gmail.com</h3>
              </div>
            </li>
          </ul>
        </div>
