...
const About = () => {
  return (
    <div className="h-full w-full leading-relaxed mt-4 mb-6">
      <div className="flex items-center justify-center p-8">
        <div className="max-w-4xl text-center mb-6">
          <h2 className="text-3xl font-bold text-white font-nunito-sans  h2">
            À Propos de Moi
          </h2>
          <p className="text-lg text-white font-mono mb-6">
            Bonjour ! Je suis <Code >Nahima Toumi</Code>,
            développeuse web passionnée et engagée. Après une reconversion professionnelle il y a plus de deux ans,
            j&apos;ai trouvé ma vocation dans la création de solutions numériques innovantes et utiles.
          </p>
          <p className="text-lg text-white font-mono mb-6">
          ...
          <p className="text-lg text-white font-mono">  Je travaille aussi avec <Code>WordPress</Code> pour le front-end et je suis fascinée par la conception et la réalisation d&apos;APIs, notamment avec <Code>Symfony</Code>.</p>
